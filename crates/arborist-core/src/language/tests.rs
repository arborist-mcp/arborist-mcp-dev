...
fn kotlin_adapter_exposes_tree_query_skeleton_index_dependency_and_trace_capabilities() {
    ...
    assert_eq!(descriptor.analysis_revision, "kotlin-patch-targeting-v33");
    for capability in [
...
#[test]
fn csharp_adapter_exposes_query_skeleton_index_dependency_and_trace_capabilities() {
    let registry = builtin_language_registry();
    ...
    assert_eq!(descriptor.analysis_revision, "csharp-file-dependencies-v36");
    for capability in [
        LanguageCapabilities::TREE_QUERY,
        LanguageCapabilities::SEMANTIC_SKELETON,
        LanguageCapabilities::SYMBOL_INDEX,
...
fn java_adapter_exposes_tree_queries_skeleton_indexing_dependencies_and_tracing() {
    ...
    assert_eq!(descriptor.analysis_revision, "java-patch-targeting-v42");
    for capability in [
        LanguageCapabilities::TREE_QUERY,
        LanguageCapabilities::SEMANTIC_SKELETON,
        LanguageCapabilities::SYMBOL_INDEX,
...
fn go_adapter_exposes_skeleton_indexing_dependencies_tracing_and_patching() {
    ...
    assert_eq!(descriptor.analysis_revision, "go-patch-targeting-v17");
    for capability in [
        LanguageCapabilities::TREE_QUERY,
        LanguageCapabilities::SEMANTIC_SKELETON,
        LanguageCapabilities::SYMBOL_INDEX,
