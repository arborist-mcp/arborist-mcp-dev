...
pub(super) fn downgrade_symbol_index_schema_to_v4(connection: &Connection) {
    connection
        .execute_batch(
            "
                DROP INDEX IF EXISTS idx_symbols_file_path;
                ALTER TABLE symbols RENAME TO symbols_v5;
                CREATE TABLE symbols (
                    symbol_id TEXT NOT NULL,
                    semantic_path TEXT NOT NULL,
                    scope_path TEXT,
...
pub(super) fn downgrade_symbol_index_schema_to_v3(connection: &Connection) {
    connection
        .execute_batch(
            "
                DROP INDEX IF EXISTS idx_symbols_file_path;
                ALTER TABLE symbols RENAME TO symbols_v4;
                CREATE TABLE symbols (
                    symbol_id TEXT NOT NULL,
                    semantic_path TEXT NOT NULL,
                    scope_path TEXT,
