...
#[test]
fn javascript_patch_binding_validation_allows_async_iife_references_after_labeled_await() {
    let source = r#"function compute(): unknown {
    return 0;
}
"#;
...
#[test]
fn javascript_patch_binding_validation_rejects_async_iife_references_in_labeled_await() {
    let source = r#"function compute(): unknown {
    return 0;
}
"#;
...
#[test]
fn javascript_patch_binding_validation_rejects_async_iife_references_in_await_if_condition() {
    let source = r#"function compute(): unknown {
    return 0;
}
"#;
...
#[test]
fn javascript_patch_binding_validation_rejects_async_iife_references_after_unbraced_conditional_for_await()
 {
    let source = r#"async function compute(shouldIterate: boolean): Promise<unknown> {
    return 0;
}
...
#[test]
fn javascript_patch_binding_validation_allows_async_iife_references_inside_unbraced_conditional_for_await()
 {
    let source = r#"async function compute(shouldIterate: boolean): Promise<unknown> {
    return 0;
}
...
#[test]
fn javascript_patch_binding_validation_rejects_async_iife_references_after_unbraced_else_for_await()
{
    let source = r#"async function compute(skipAwait: boolean): Promise<unknown> {
    return 0;
}
"#;
    let replacement = r#"async function compute(skipAwait: boolean): Promise<unknown> {
    const value = (async () => {
        if (skipAwait)
            void 0;
        else
