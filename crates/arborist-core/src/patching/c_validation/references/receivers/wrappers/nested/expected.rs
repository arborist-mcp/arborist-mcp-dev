...
use crate::patching::c_validation::cpp_wrappers::{
    ...
    cpp_standard_optional_target_type, cpp_standard_smart_pointer_target_type,
};
...
use super::{
    cpp_expected_error_receiver, cpp_optional_wrapper_only_receiver,
    cpp_standard_optional_value_member_receiver, cpp_standard_value_member_receiver,
    cpp_strip_expected_error_access, cpp_strip_optional_value_access,
};

pub(in crate::patching::c_validation::references) fn cpp_standard_expected_error_member_receiver(
    expression: &str,
    byte_offset: usize,
...
pub(in crate::patching::c_validation::references) fn cpp_expected_error_nested_arrow_member_receiver(
    expression: &str,
    byte_offset: usize,
    local_bindings: &[CppLocalBinding],
) -> Option<(String, CppThisMemberReceiver)> {
...
pub(in crate::patching::c_validation::references) fn cpp_expected_error_optional_arrow_member_receiver(
    expression: &str,
    byte_offset: usize,
    local_bindings: &[CppLocalBinding],
) -> Option<(String, CppThisMemberReceiver)> {
...
pub(in crate::patching::c_validation::references) fn cpp_expected_error_optional_value_member_receiver(
    expression: &str,
    byte_offset: usize,
    local_bindings: &[CppLocalBinding],
) -> Option<(String, CppThisMemberReceiver)> {
...
pub(in crate::patching::c_validation::references) fn cpp_expected_error_optional_dereference_receiver(
    expression: &str,
    byte_offset: usize,
    local_bindings: &[CppLocalBinding],
) -> Option<(String, CppThisMemberReceiver)> {
...
pub(in crate::patching::c_validation::references) fn cpp_expected_error_type_from_wrapper(
    type_name: &str,
...
pub(in crate::patching::c_validation::references) fn cpp_expected_local_binding_error_receiver(
    expression: &str,
    byte_offset: usize,
    local_bindings: &[CppLocalBinding],
) -> Option<(String, CppThisMemberReceiver)> {
