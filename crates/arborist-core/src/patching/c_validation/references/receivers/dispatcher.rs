...
use super::super::super::cpp_wrappers::cpp_standard_smart_pointer_target_type;
use super::super::bindings::{cpp_address_binding, cpp_named_reference_alias_receiver};
...
use super::binding_lookup::*;
use super::sequence::*;
use super::wrappers::*;

pub(in crate::patching::c_validation) fn cpp_local_member_receiver_type(
    argument: Node<'_>,
    source: &str,
...
pub(in super::super) fn cpp_local_member_receiver_from_expression(
    expression: &str,
    byte_offset: usize,
    local_bindings: &[CppLocalBinding],
    member_operator: &str,
