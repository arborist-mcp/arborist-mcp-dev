...
pub fn search_symbols_from_index_with_source_filtered_with_timeout(
    db_path: &Path,
    path: &Path,
    source: &str,
    query: &str,
...
#[allow(clippy::too_many_arguments)]
pub fn search_symbols_context_from_index_with_source_filtered_with_timeout(
    db_path: &Path,
    path: &Path,
    source: &str,
    query: &str,
...
#[allow(clippy::too_many_arguments)]
pub fn search_symbols_neighborhood_context_from_index_with_source_filtered_with_timeout(
    db_path: &Path,
    path: &Path,
    source: &str,
    query: &str,
