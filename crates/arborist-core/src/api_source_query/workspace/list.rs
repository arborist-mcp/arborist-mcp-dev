...
pub fn list_symbols_context_with_source_filtered_with_timeout(
    workspace_root: &Path,
    path: &Path,
    source: &str,
    limit: usize,
...
#[allow(clippy::too_many_arguments)]
pub fn list_symbols_neighborhood_context_with_source_filtered_with_timeout(
    workspace_root: &Path,
    path: &Path,
    source: &str,
    limit: usize,
...
#[allow(clippy::too_many_arguments)]
pub fn list_symbols_discovery_context_with_source_filtered_with_timeout(
    workspace_root: &Path,
    path: &Path,
    source: &str,
    limit: usize,
