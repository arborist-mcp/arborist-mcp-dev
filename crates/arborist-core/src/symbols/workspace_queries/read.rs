...
use super::load_live_workspace_symbols_at_path_with_timeout;

pub fn read_symbol(workspace_root: &Path, symbol_path: &str) -> Result<SymbolReadResult> {
    read_symbol_with_timeout(workspace_root, symbol_path, None)
}
...
pub fn read_symbol_context(
    ...
    read_symbol_context_with_timeout(workspace_root, symbol_path, direction, None)
}
...
pub fn read_symbol_at_position(
    ...
    read_symbol_at_position_with_timeout(workspace_root, file_path, position, None)
}
