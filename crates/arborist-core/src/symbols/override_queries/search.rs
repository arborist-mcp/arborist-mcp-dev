...
pub(crate) fn search_symbols_from_index_with_overrides_filtered_with_deadline(
    db_path: &Path,
    file_overrides: &BTreeMap<String, String>,
    query: &str,
    limit: usize,
...
pub(crate) fn search_symbols_context_with_overrides_filtered_with_deadline(
    workspace_root: &Path,
    file_overrides: &BTreeMap<String, String>,
    query: &str,
    limit: usize,
...
pub(crate) fn search_symbols_context_from_index_with_overrides_filtered_with_deadline(
    db_path: &Path,
    file_overrides: &BTreeMap<String, String>,
    query: &str,
    limit: usize,
...
pub(crate) fn search_symbols_neighborhood_context_with_overrides_filtered_with_deadline(
    workspace_root: &Path,
    file_overrides: &BTreeMap<String, String>,
    query: &str,
    limit: usize,
...
#[allow(clippy::too_many_arguments)]
pub(crate) fn search_symbols_neighborhood_context_from_index_with_overrides_filtered_with_deadline(
    db_path: &Path,
    file_overrides: &BTreeMap<String, String>,
    query: &str,
    limit: usize,
...
#[allow(clippy::too_many_arguments)]
pub(crate) fn search_symbols_discovery_context_with_overrides_filtered_with_deadline(
    workspace_root: &Path,
    file_overrides: &BTreeMap<String, String>,
    query: &str,
    limit: usize,
...
#[allow(clippy::too_many_arguments)]
pub(crate) fn search_symbols_discovery_context_from_index_with_overrides_filtered_with_deadline(
    db_path: &Path,
    file_overrides: &BTreeMap<String, String>,
    query: &str,
    limit: usize,
