...
class TestWorkflowTests(unittest.TestCase):
    ...
    def test_python_fast_group_extends_gateway_fast_with_workflow_tests(self) -> None:
        self.assertEqual(
            ...
            (
                ...
                "tests.test_index_watch_runtime_edges",
                "tests.test_mcp_surface",
                "tests.test_batch_and_jsonrpc",
                "tests.test_core_helpers_and_notifications",
    ...
    def test_test_script_show_plan_reports_deduplicated_execution_steps(self) -> None:
        ...
        self.assertEqual(lines[1], "python  <- python-fast, gateway-fast [pure-python; 11 module(s)]")
        self.assertEqual(
            lines[2:],
