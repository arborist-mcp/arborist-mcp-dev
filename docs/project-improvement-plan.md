...
- [x] Model named-namespace free functions and named class methods, including
  class out-of-line definitions, in C++ skeletons, indexes, traces, patch
  targets, and raw-query owner metadata.
- [ ] Extend C++ semantic support to constructors, templates, and
