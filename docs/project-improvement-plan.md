...
- [x] Align Python's declared file-dependency capability with bounded local `import`/`from ... import ...` resolution for `.py`/`.pyi` modules and packages. This includes wildcard package imports and incremental invalidation of package `__init__.py`.
