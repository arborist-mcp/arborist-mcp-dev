...
- C#: `.cs` — Tree-sitter parsing, raw queries, and semantic skeletons for block and
  ...
  Symbol indexing, dependency refresh, tracing, and patch operations return explicit
  unsupported-operation errors until dedicated C# adapter slices establish their contracts and fixtures.
