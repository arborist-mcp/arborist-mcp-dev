...
**Status:** Phases 1-4 implemented; Phase 5 Rust and Go skeleton/index/dependency/trace slices, Java query/semantic-skeleton/declaration-indexing/import-dependency/direct-trace slices, and C# parsing/raw-query/semantic-skeleton/declaration-indexing/local/file-alias/static-import trace slices implemented
...
4. C#: parsing, raw-query compatibility, semantic skeletons, declaration indexing, same-type
   ...
   static-call tracing, file-root type-alias static-call tracing, and file-root `using static` bare-call tracing are established; add dependencies and broader
