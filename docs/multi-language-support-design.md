...
4. C#: parsing, raw-query compatibility, semantic skeletons, declaration indexing, same-type
   ...
   cross-file simple same-namespace and enclosing-namespace static-call tracing and bounded outer/nested-type static-call tracing, including from nested source types, root, exact, and enclosing namespace-scoped
