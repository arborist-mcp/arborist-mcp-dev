...
4. C#: parsing, raw-query compatibility, semantic skeletons, declaration indexing, and same-type
   unqualified/explicit-`this` method and constructor-initializer tracing are established; add dependencies and broader tracing only through
