...
4. C#: parsing, raw-query compatibility, semantic skeletons, declaration indexing, same-type
   ...
   cross-file simple same-namespace static-call tracing, root and exact namespace-scoped type-alias/static-import
   bare-call and namespace-import static-call tracing are
