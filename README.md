...
- C#: `.cs` — Tree-sitter parsing, raw queries, semantic skeletons, declaration indexing, and
  ...
  `using Fully.Qualified.Namespace;` calls of the form `Type.Method()`. Type aliases, static imports, and namespace imports may appear at file root or
  ...
  `global using` aliases and namespace imports, dependency refresh, other member dispatch, overload type selection, and patching remain explicitly
...
- C# Tree-sitter parsing, raw query execution, semantic skeletons, declaration indexing, and
  ...
  (including directive-only files), and namespace-import `Type.Method()` calls. Exact namespace
  ...
  alias/import inheritance, `global using` aliases and namespace imports, dependency refresh, other member dispatch, overload type selection, and
