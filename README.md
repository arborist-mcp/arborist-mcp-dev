...
- C#: `.cs` — Tree-sitter parsing, raw queries, semantic skeletons, declaration indexing, and
  ...
  ignored or fail closed, and unknown bare identifiers fail closed. Outer-namespace alias/import inheritance,
  other member dispatch, and overload type selection remain explicitly unavailable until dedicated C# adapter
