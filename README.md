...
- JavaScript, TypeScript, and TSX Tree-sitter parsing, query execution,
  semantic skeletons, conservative direct-call symbol indexing/tracing, and
  static local module dependency refresh; module-aware import resolution and
  patching remain capability-gated until their adapters land.
