...
- Go: `.go` — Tree-sitter parsing, raw queries, semantic skeletons, and conservative declaration
  ...
  `replace`, `go.work`, vendoring, build tags, general cross-file/package/import resolution, qualified imported conversions, aliases used in conversion/assertion receiver forms, interface dispatch, other method dispatch,
...
- Go Tree-sitter parsing, raw query execution, semantic skeletons, and conservative declaration
  ...
  general cross-file/package/import resolution, qualified imported conversions, aliases used in conversion/assertion receiver forms, interface dispatch, and other method dispatch remain unavailable;
