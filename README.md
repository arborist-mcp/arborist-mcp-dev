...
- The stdio gateway rejects non-standard JSON constants such as `NaN` and `Infinity`, malformed `did_change` edit payloads, fractional request IDs, negative numeric parameters, and non-standard response JSON at the protocol boundary
