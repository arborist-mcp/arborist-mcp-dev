...
- JavaScript, TypeScript, and TSX Tree-sitter parsing and query execution with
  explicit capability gates; workspace symbol indexing, traces, and patching
  remain disabled until their language adapters are implemented.
