...
- Persisted trace reads and single-file refreshes also reject existing non-index or incomplete-schema SQLite databases without initializing or partially migrating Arborist tables as a side effect
