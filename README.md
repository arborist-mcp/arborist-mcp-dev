...
- JavaScript, TypeScript, and TSX Tree-sitter parsing, query execution,
  semantic skeletons, conservative direct-call and local named-import tracing,
  and static local module dependency refresh; re-export/default/namespace
  resolution and patching remain capability-gated until their adapters land.
